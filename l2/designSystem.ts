/// <mls fileReference="_102048_/l2/designSystem.ts" enhancement="_blank" />
...
export const tokens: IDesignSystemTokens[] = [
    ...
    {
        themeName: "Canteiro",
        description: "Tema quente de canteiro de obras — terracota e neutros terrosos (dia e noite); status e séries de gráfico idênticos ao Default",
        color: {
            "page-bg": "#f4f1ec",
            "page-bg-hover": "#e6e2da",
            "page-bg-focus": "#d8d3c9",
            "page-bg-disabled": "#f4f1ec",
            "surface-bg": "#ffffff",
            "surface-bg-hover": "#f1ede6",
            "surface-bg-focus": "#e4dfd6",
            "surface-bg-disabled": "#f8f6f1",
            "surface-alt-bg": "#f7f4ee",
            "surface-alt-bg-hover": "#e8e4dc",
            "surface-alt-bg-focus": "#d9d5cc",
            "surface-alt-bg-disabled": "#f4f1ea",
            "input-bg": "#ffffff",
            "input-bg-hover": "#f1ede6",
            "input-bg-focus": "#e4dfd6",
            "input-bg-disabled": "#f8f6f1",
            "text-strong": "#211a12",
            "text-strong-hover": "#1f1911",
            "text-strong-focus": "#1d1710",
            "text-strong-disabled": "#93887a",
            "text-default": "#483c2d",
            "text-default-hover": "#43382a",
            "text-default-focus": "#3f3527",
            "text-default-disabled": "#a29684",
            "text-muted": "#7b6d5b",
            "text-muted-hover": "#726551",
            "text-muted-focus": "#6a5e4e",
            "text-muted-disabled": "#bdb2a1",
            "border-default": "#dcd2c2",
            "border-default-hover": "#cec4b4",
            "border-default-focus": "#c0b7a8",
            "border-default-disabled": "#eae3d7",
            "border-subtle": "#eae3d7",
            "border-subtle-hover": "#d9d2c6",
            "border-subtle-focus": "#cac3b8",
            "border-subtle-disabled": "#f0ebe1",
            "button-primary-bg": "#c2571b",
            "button-primary-bg-hover": "#b45118",
            "button-primary-bg-focus": "#a94c16",
            "button-primary-bg-disabled": "#e2b393",
            "button-primary-text": "#ffffff",
            "button-primary-text-hover": "#f5ece4",
            "button-primary-text-focus": "#ecdfd2",
            "button-primary-text-disabled": "#faf6f1",
            "button-secondary-bg": "#ffffff",
            "button-secondary-bg-hover": "#f1ede6",
            "button-secondary-bg-focus": "#e4dfd6",
            "button-secondary-bg-disabled": "#f8f6f1",
            "button-secondary-text": "#483c2d",
            "button-secondary-text-hover": "#43382a",
            "button-secondary-text-focus": "#3f3527",
            "button-secondary-text-disabled": "#a29684",
            "button-secondary-border": "#cfc3b0",
            "button-secondary-border-hover": "#c1b6a4",
            "button-secondary-border-focus": "#b4aa99",
            "button-secondary-border-disabled": "#e3dccf",
            "button-danger-bg": "#c92a2e",
            "button-danger-bg-hover": "#bb272b",
            "button-danger-bg-focus": "#af2528",
            "button-danger-bg-disabled": "#dd979b",
            ...
            "button-danger-text-disabled": "#f6f7fa",
            "link-text": "#a04a12",
            "link-text-hover": "#944510",
            "link-text-focus": "#8a400f",
            "link-text-disabled": "#d0a480",
            "focus-ring": "#eba565",
            "focus-ring-hover": "#dc9a5e",
            "focus-ring-focus": "#cd9058",
            "focus-ring-disabled": "#f3d0ac",
            "selected-bg": "#fbecdc",
            "selected-bg-hover": "#e9dbcc",
            "selected-bg-focus": "#dccfc0",
            "selected-bg-disabled": "#f9f0e6",
            "selected-text": "#8a430e",
            "selected-text-hover": "#813e0d",
            "selected-text-focus": "#783a0c",
            "selected-text-disabled": "#c99f77",
            "selected-border": "#c2571b",
            "selected-border-hover": "#b45118",
            "selected-border-focus": "#a94c16",
            "selected-border-disabled": "#e2b393",
            "status-success-bg": "#e2f5db",
            "status-success-bg-hover": "#d2e4cc",
            "status-success-bg-focus": "#c5d5bf",
            "status-success-bg-disabled": "#e9f3e9",
            ...
            "nav-bg-hover": "#231e18",
            "nav-bg-focus": "#201b16",
            "nav-bg-disabled": "#97918b",
            "nav-text": "#d9cfc2",
            "nav-text-hover": "#cac1b5",
            "nav-text-focus": "#bcb4a8",
            "nav-text-disabled": "#e8e1d7",
            "nav-active-bg": "#4d3925",
            "nav-active-bg-hover": "#473522",
            "nav-active-bg-focus": "#423120",
            "nav-active-bg-disabled": "#a49a8d",
            "nav-active-text": "#ffffff",
            "nav-active-text-hover": "#f5ece4",
            "nav-active-text-focus": "#ecdfd2",
            "nav-active-text-disabled": "#faf6f1",
            "overlay-backdrop-bg": "rgba(20, 14, 8, 0.55)",
            "overlay-backdrop-bg-hover": "rgba(20, 14, 8, 0.55)",
            "overlay-backdrop-bg-focus": "rgba(20, 14, 8, 0.55)",
            "overlay-backdrop-bg-disabled": "rgba(20, 14, 8, 0.55)",
            "tooltip-bg": "#26201a",
            "tooltip-bg-hover": "#231e18",
            "tooltip-bg-focus": "#201b16",
            "tooltip-bg-disabled": "#97918b",
            "tooltip-text": "#f6f0e8",
            "tooltip-text-hover": "#e5dfd7",
            "tooltip-text-focus": "#d5d0c8",
            "tooltip-text-disabled": "#f3eee7",
            "chart-series-1": "#2a78d6",
            "chart-series-1-hover": "#2770c7",
            "chart-series-1-focus": "#2568ba",
            "chart-series-1-disabled": "#96bbe7",
            ...
            "chart-series-6-focus": "#c5403f",
            "chart-series-6-disabled": "#e9a5a7",
            "_dark-page-bg": "#14100b",
            "_dark-page-bg-hover": "#221e18",
            "_dark-page-bg-focus": "#302c25",
            "_dark-page-bg-disabled": "#14100b",
            "_dark-surface-bg": "#1d1811",
            "_dark-surface-bg-hover": "#2c2720",
            "_dark-surface-bg-focus": "#3a352d",
            "_dark-surface-bg-disabled": "#17130d",
            "_dark-surface-alt-bg": "#272117",
            "_dark-surface-alt-bg-hover": "#363026",
            "_dark-surface-alt-bg-focus": "#443d33",
            "_dark-surface-alt-bg-disabled": "#1c1710",
            "_dark-input-bg": "#171209",
            "_dark-input-bg-hover": "#262119",
            "_dark-input-bg-focus": "#343026",
            "_dark-input-bg-disabled": "#130f08",
            "_dark-text-strong": "#f6f0e7",
            "_dark-text-strong-hover": "#f7f1e9",
            "_dark-text-strong-focus": "#f8f2ea",
            "_dark-text-strong-disabled": "#7b756c",
            "_dark-text-default": "#e3d9ca",
            "_dark-text-default-hover": "#e6dccf",
            "_dark-text-default-focus": "#e8dfd3",
            "_dark-text-default-disabled": "#6f695f",
            "_dark-text-muted": "#ab9d88",
            "_dark-text-muted-hover": "#b2a490",
            "_dark-text-muted-focus": "#b8ab98",
            "_dark-text-muted-disabled": "#564e42",
            "_dark-border-default": "#4c4232",
            "_dark-border-default-hover": "#59503f",
            "_dark-border-default-focus": "#655c4b",
            "_dark-border-default-disabled": "#2b2419",
            "_dark-border-subtle": "#322a1e",
            "_dark-border-subtle-hover": "#40382b",
            "_dark-border-subtle-focus": "#4d4537",
            "_dark-border-subtle-disabled": "#201a11",
            "_dark-button-primary-bg": "#e98e46",
            "_dark-button-primary-bg-hover": "#eb9754",
            "_dark-button-primary-bg-focus": "#eda061",
            "_dark-button-primary-bg-disabled": "#77441f",
            "_dark-button-primary-text": "#1f1104",
            "_dark-button-primary-text-hover": "#2f2013",
            "_dark-button-primary-text-focus": "#3c2d20",
            "_dark-button-primary-text-disabled": "#170e06",
            "_dark-button-secondary-bg": "#272117",
            "_dark-button-secondary-bg-hover": "#363026",
            "_dark-button-secondary-bg-focus": "#443d33",
            "_dark-button-secondary-bg-disabled": "#1c1710",
            "_dark-button-secondary-text": "#e3d9ca",
            "_dark-button-secondary-text-hover": "#e6dccf",
            "_dark-button-secondary-text-focus": "#e8dfd3",
            "_dark-button-secondary-text-disabled": "#6f695f",
            "_dark-button-secondary-border": "#4c4232",
            "_dark-button-secondary-border-hover": "#59503f",
            "_dark-button-secondary-border-focus": "#655c4b",
            "_dark-button-secondary-border-disabled": "#2b2419",
            "_dark-button-danger-bg": "#e2555a",
            "_dark-button-danger-bg-hover": "#e46166",
            "_dark-button-danger-bg-focus": "#e66b6f",
            "_dark-button-danger-bg-disabled": "#6d3035",
            ...
            "_dark-button-danger-text-focus": "#3c2728",
            "_dark-button-danger-text-disabled": "#150c10",
            "_dark-link-text": "#f0a76b",
            "_dark-link-text-hover": "#f1ad76",
            "_dark-link-text-focus": "#f2b381",
            "_dark-link-text-disabled": "#7c5637",
            "_dark-focus-ring": "#ffab5e",
            "_dark-focus-ring-hover": "#ffb26b",
            "_dark-focus-ring-focus": "#ffb876",
            "_dark-focus-ring-disabled": "#7f5730",
            "_dark-selected-bg": "#4a3218",
            "_dark-selected-bg-hover": "#573f28",
            "_dark-selected-bg-focus": "#634c36",
            "_dark-selected-bg-disabled": "#2c2012",
            "_dark-selected-text": "#f4bc85",
            "_dark-selected-text-hover": "#f5c18e",
            "_dark-selected-text-focus": "#f5c697",
            "_dark-selected-text-disabled": "#7a5f43",
            "_dark-selected-border": "#e98e46",
            "_dark-selected-border-hover": "#eb9754",
            "_dark-selected-border-focus": "#eda061",
            "_dark-selected-border-disabled": "#77441f",
            "_dark-status-success-bg": "#1c3617",
            "_dark-status-success-bg-hover": "#2c4427",
            "_dark-status-success-bg-focus": "#3a5035",
            "_dark-status-success-bg-disabled": "#142217",
            ...
            "_dark-status-neutral-text-disabled": "#565e67",
            "_dark-nav-bg": "#171209",
            "_dark-nav-bg-hover": "#262119",
            "_dark-nav-bg-focus": "#343026",
            "_dark-nav-bg-disabled": "#130f08",
            "_dark-nav-text": "#ab9d88",
            "_dark-nav-text-hover": "#b2a490",
            "_dark-nav-text-focus": "#b8ab98",
            "_dark-nav-text-disabled": "#564e42",
            "_dark-nav-active-bg": "#4a3218",
            "_dark-nav-active-bg-hover": "#573f28",
            "_dark-nav-active-bg-focus": "#634c36",
            "_dark-nav-active-bg-disabled": "#2c2012",
            "_dark-nav-active-text": "#f4bc85",
            "_dark-nav-active-text-hover": "#f5c18e",
            "_dark-nav-active-text-focus": "#f5c697",
            "_dark-nav-active-text-disabled": "#7a5f43",
            "_dark-overlay-backdrop-bg": "rgba(0, 0, 0, 0.65)",
            "_dark-overlay-backdrop-bg-hover": "rgba(0, 0, 0, 0.65)",
            "_dark-overlay-backdrop-bg-focus": "rgba(0, 0, 0, 0.65)",
            "_dark-overlay-backdrop-bg-disabled": "rgba(0, 0, 0, 0.65)",
            "_dark-tooltip-bg": "#383024",
            "_dark-tooltip-bg-hover": "#463e31",
            "_dark-tooltip-bg-focus": "#534a3c",
            "_dark-tooltip-bg-disabled": "#221c12",
            "_dark-tooltip-text": "#f6f0e7",
            "_dark-tooltip-text-hover": "#f7f1e9",
            "_dark-tooltip-text-focus": "#f8f2ea",
            "_dark-tooltip-text-disabled": "#7b756c",
            "_dark-chart-series-1": "#3987e5",
            "_dark-chart-series-1-hover": "#478fe7",
            "_dark-chart-series-1-focus": "#5397e8",
            "_dark-chart-series-1-disabled": "#214674",
